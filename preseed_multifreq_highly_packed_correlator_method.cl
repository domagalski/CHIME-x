...
//     //row 0
//     corr_buf[addr_o+0u]=   NUM_TIMESAMPLES_x_128 - 8u*(xVals.s0 + yVals.s0 + yVals.s1)+7u*xVals.s1; //real value correction
//     corr_buf[addr_o+1u]=                         - 8u*(xVals.s1 + yVals.s0 - yVals.s1)-7u*xVals.s0; //imaginary value correction (the extra subtraction in the notes has been performed by swapping order above
//     corr_buf[addr_o+2u]=   NUM_TIMESAMPLES_x_128 - 8u*(xVals.s2 + yVals.s0 + yVals.s1)+7u*xVals.s3; //note that x changes, but y stays the same
//     corr_buf[addr_o+3u]=                         - 8u*(xVals.s3 + yVals.s0 - yVals.s1)-7u*xVals.s2;
//     corr_buf[addr_o+4u]=   NUM_TIMESAMPLES_x_128 - 8u*(xVals.s4 + yVals.s0 + yVals.s1)+7u*xVals.s5; //real value correction
//     corr_buf[addr_o+5u]=                         - 8u*(xVals.s5 + yVals.s0 - yVals.s1)-7u*xVals.s4; //imaginary value correction (the extra subtraction in the notes has been performed by swapping order above
//     corr_buf[addr_o+6u]=   NUM_TIMESAMPLES_x_128 - 8u*(xVals.s6 + yVals.s0 + yVals.s1)+7u*xVals.s7;
//     corr_buf[addr_o+7u]=                         - 8u*(xVals.s7 + yVals.s0 - yVals.s1)-7u*xVals.s6;
//     //row 1
//     corr_buf[addr_o+64u]=   NUM_TIMESAMPLES_x_128 - 8u*(xVals.s0 + yVals.s2 + yVals.s3)+7u*xVals.s1; //real value correction
//     corr_buf[addr_o+65u]=                         - 8u*(xVals.s1 + yVals.s2 - yVals.s3)-7u*xVals.s0; //imaginary value correction (the extra subtraction in the notes has been performed by swapping order above
//     corr_buf[addr_o+66u]=   NUM_TIMESAMPLES_x_128 - 8u*(xVals.s2 + yVals.s2 + yVals.s3)+7u*xVals.s3; //note that x changes, but y stays the same
//     corr_buf[addr_o+67u]=                         - 8u*(xVals.s3 + yVals.s2 - yVals.s3)-7u*xVals.s2;
//     corr_buf[addr_o+68u]=   NUM_TIMESAMPLES_x_128 - 8u*(xVals.s4 + yVals.s2 + yVals.s3)+7u*xVals.s5; //real value correction
//     corr_buf[addr_o+69u]=                         - 8u*(xVals.s5 + yVals.s2 - yVals.s3)-7u*xVals.s4; //imaginary value correction (the extra subtraction in the notes has been performed by swapping order above
//     corr_buf[addr_o+70u]=   NUM_TIMESAMPLES_x_128 - 8u*(xVals.s6 + yVals.s2 + yVals.s3)+7u*xVals.s7;
//     corr_buf[addr_o+71u]=                         - 8u*(xVals.s7 + yVals.s2 - yVals.s3)-7u*xVals.s6;
//     //row 2
//     corr_buf[addr_o+128u]=   NUM_TIMESAMPLES_x_128 - 8u*(xVals.s0 + yVals.s4 + yVals.s5)+7u*xVals.s1; //real value correction
//     corr_buf[addr_o+129u]=                         - 8u*(xVals.s1 + yVals.s4 - yVals.s5)-7u*xVals.s0; //imaginary value correction (the extra subtraction in the notes has been performed by swapping order above
//     corr_buf[addr_o+130u]=   NUM_TIMESAMPLES_x_128 - 8u*(xVals.s2 + yVals.s4 + yVals.s5)+7u*xVals.s3; //note that x changes, but y stays the same
//     corr_buf[addr_o+131u]=                         - 8u*(xVals.s3 + yVals.s4 - yVals.s5)-7u*xVals.s2;
//     corr_buf[addr_o+132u]=   NUM_TIMESAMPLES_x_128 - 8u*(xVals.s4 + yVals.s4 + yVals.s5)+7u*xVals.s5; //real value correction
//     corr_buf[addr_o+133u]=                         - 8u*(xVals.s5 + yVals.s4 - yVals.s5)-7u*xVals.s4; //imaginary value correction (the extra subtraction in the notes has been performed by swapping order above
//     corr_buf[addr_o+134u]=   NUM_TIMESAMPLES_x_128 - 8u*(xVals.s6 + yVals.s4 + yVals.s5)+7u*xVals.s7;
//     corr_buf[addr_o+135u]=                         - 8u*(xVals.s7 + yVals.s4 - yVals.s5)-7u*xVals.s6;
//     //row 3
//     corr_buf[addr_o+192u]=   NUM_TIMESAMPLES_x_128 - 8u*(xVals.s0 + yVals.s6 + yVals.s7)+7u*xVals.s1; //real value correction
//     corr_buf[addr_o+193u]=                         - 8u*(xVals.s1 + yVals.s6 - yVals.s7)-7u*xVals.s0; //imaginary value correction (the extra subtraction in the notes has been performed by swapping order above
//     corr_buf[addr_o+194u]=   NUM_TIMESAMPLES_x_128 - 8u*(xVals.s2 + yVals.s6 + yVals.s7)+7u*xVals.s3; //note that x changes, but y stays the same
//     corr_buf[addr_o+195u]=                         - 8u*(xVals.s3 + yVals.s6 - yVals.s7)-7u*xVals.s2;
//     corr_buf[addr_o+196u]=   NUM_TIMESAMPLES_x_128 - 8u*(xVals.s4 + yVals.s6 + yVals.s7)+7u*xVals.s5; //real value correction
//     corr_buf[addr_o+197u]=                         - 8u*(xVals.s5 + yVals.s6 - yVals.s7)-7u*xVals.s4; //imaginary value correction (the extra subtraction in the notes has been performed by swapping order above
//     corr_buf[addr_o+198u]=   NUM_TIMESAMPLES_x_128 - 8u*(xVals.s6 + yVals.s6 + yVals.s7)+7u*xVals.s7;
//     corr_buf[addr_o+199u]=                         - 8u*(xVals.s7 + yVals.s6 - yVals.s7)-7u*xVals.s6;
}
